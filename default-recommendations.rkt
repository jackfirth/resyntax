...
(provide (all-from-out resyntax/default-recommendations/boolean-shortcuts
         ...
         (contract-out [default-recommendations refactoring-suite?]))
...
(define-refactoring-suite
 ...
 #:suites (boolean-shortcuts class-shortcuts
