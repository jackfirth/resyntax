...
test:
"hash? and immutable? can be refactored to immutable-hash?"
-
...
test:
"string? and immutable? can be refactored to immutable-string?"
-
...
test:
"bytes? and immutable? can be refactored to immutable-bytes?"
-
...
test:
"vector? and immutable? can be refactored to immutable-vector?"
-
...
test:
"box? and immutable? can be refactored to immutable-box?"
-
...
test:
"hash? and (not/c immutable?) can be refactored to mutable-hash?"
-
...
test:
"string? and (not/c immutable?) can be refactored to mutable-string?"
-
...
test:
"bytes? and (not/c immutable?) can be refactored to mutable-bytes?"
-
...
test:
"vector? and (not/c immutable?) can be refactored to mutable-vector?"
-
...
test:
"box? and (not/c immutable?) can be refactored to mutable-box?"
-
