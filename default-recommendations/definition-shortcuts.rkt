...
(provide (contract-out [definition-shortcuts refactoring-suite?]))
...
(define-definition-context-refactoring-rule
 ...
 #:when (match (syntax-property #'id1 'identifier-usages)
          ...
          [_ #false])
 #:with replacement
 #'(~replacement expr #:original-splice (definition id2))
 #:with focused
...
(define-definition-context-refactoring-rule
 ...
 (~seq body-before ...
       ...
       body-after ...)
 #:with (replacement ...)
 #'(~focus-replacement-on (~splicing-replacement (pre-body ... (define id expr))
                                                 #:original definition))
 (body-before ... replacement ... body-after ...))
...
(define-definition-context-refactoring-rule
 ...
 (~seq body-before ...
       ...
       body-after ...)
 #:with (replacement ...)
 #'(~focus-replacement-on (~splicing-replacement ((define id expr) post-body ...)
                                                 #:original definition))
 (body-before ... replacement ... body-after ...))

(define-definition-context-refactoring-rule
 begin0-begin-extraction
 #:description
 ...
 (~seq body-before ...
       (~and outer-form
             (begin0 (begin
               ...
               post-body ...)))
 #:with (replacement ...)
 #'(~focus-replacement-on (~splicing-replacement (pre-body ...
                                                  (begin0 expr
                                                    post-body ...))
                                                 #:original outer-form))
...
(define-refactoring-suite definition-shortcuts
                          #:rules (begin0-begin-extraction define-begin-extraction
                                                           define-begin0-extraction
                                                           define-values-values-to-define
                                                           inline-unnecessary-begin
                                                           inline-unnecessary-define))
