...
(provide (contract-out [gap-preservation-rules refactoring-suite?]))
...
(define-refactoring-rule suggest-inserting-foo-first
                         #:description
                         "This refactoring rule is for testing Resyntax, ignore its suggestions."
...
(define-refactoring-suite gap-preservation-rules
                          #:rules
                          (suggest-inserting-foo-first suggest-inserting-foo-second
