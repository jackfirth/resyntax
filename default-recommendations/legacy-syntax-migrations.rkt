...
(provide (contract-out [legacy-syntax-migrations refactoring-suite?]))
...
(define-refactoring-rule syntax-recertify-migration
                         #:description
                         "The `syntax-recertify` function is a legacy function that does nothing."
...
(define-refactoring-rule syntax-rearm-migration
                         #:description
                         "The `syntax-rearm` function is a legacy function that does nothing."
...
(define-refactoring-rule syntax-protect-migration
                         #:description
                         "The `syntax-protect` function is a legacy function that does nothing."
...
(define-refactoring-suite
 ...
 #:rules (datum->syntax-migration for-clause-syntax-protect-migration
