...
(provide (contract-out [list-shortcuts refactoring-suite?]))
...
(define-syntax-class list-selection-expression
  ...
  #:literals
  (list-ref first second third fourth fifth sixth seventh eighth ninth tenth car cadr caddr cadddr)

  (pattern (list-ref target-list-id:id index-stx:nat)
    #:attr index (syntax-e #'index-stx))
  (pattern (first target-list-id:id)
    #:attr index 0)
  (pattern (second target-list-id:id)
    #:attr index 1)
  (pattern (third target-list-id:id)
    #:attr index 2)
  (pattern (fourth target-list-id:id)
    #:attr index 3)
  (pattern (fifth target-list-id:id)
    #:attr index 4)
  (pattern (sixth target-list-id:id)
    #:attr index 5)
  (pattern (seventh target-list-id:id)
    #:attr index 6)
  (pattern (eighth target-list-id:id)
    #:attr index 7)
  (pattern (ninth target-list-id:id)
    #:attr index 8)
  (pattern (tenth target-list-id:id)
    #:attr index 9)
  (pattern (car target-list-id:id)
    #:attr index 0)
  (pattern (cadr target-list-id:id)
    #:attr index 1)
  (pattern (caddr target-list-id:id)
    #:attr index 2)
  (pattern (cadddr target-list-id:id)
    #:attr index 3))
...
(define-refactoring-rule
 ...
 #:with target-list-id
 (first (attribute selection.target-list-id))
 ...
 (if (zero? first-index)
     #'target-list-id
     #`(drop target-list-id #,first-index))
 #:with amount-to-take
 (- (add1 last-index) first-index)
