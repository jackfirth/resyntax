...
test:
"should migrate make-temporary-file with 'directory to make-temporary-directory"
-
...
test:
"should migrate make-temporary-file with template and 'directory to make-temporary-directory"
-
...
test:
"should migrate make-temporary-file with base-dir and 'directory to make-temporary-directory"
-
