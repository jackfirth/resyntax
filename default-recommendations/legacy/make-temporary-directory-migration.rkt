...
(provide
 (contract-out
  [make-temporary-directory-migration refactoring-suite?]))
...
(define-refactoring-rule make-temporary-file-to-make-temporary-directory
...
(define-refactoring-suite make-temporary-directory-migration
  #:rules (make-temporary-file-to-make-temporary-directory))
