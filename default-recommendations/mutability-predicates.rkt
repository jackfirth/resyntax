...
(provide (contract-out [mutability-predicates refactoring-suite?]))
...
(define-refactoring-rule hash-and-immutable-to-immutable-hash
                         #:description
                         "This contract is equivalent to the `immutable-hash?` predicate."
...
(define-refactoring-rule string-and-immutable-to-immutable-string
                         #:description
                         "This contract is equivalent to the `immutable-string?` predicate."
...
(define-refactoring-rule bytes-and-immutable-to-immutable-bytes
                         #:description
                         "This contract is equivalent to the `immutable-bytes?` predicate."
...
(define-refactoring-rule vector-and-immutable-to-immutable-vector
                         #:description
                         "This contract is equivalent to the `immutable-vector?` predicate."
...
(define-refactoring-rule box-and-immutable-to-immutable-box
                         #:description
                         "This contract is equivalent to the `immutable-box?` predicate."
...
(define-refactoring-rule string-and-mutable-to-mutable-string
                         #:description
                         "This contract is equivalent to the `mutable-string?` predicate."
...
(define-refactoring-rule bytes-and-mutable-to-mutable-bytes
                         #:description
                         "This contract is equivalent to the `mutable-bytes?` predicate."
...
(define-refactoring-rule vector-and-mutable-to-mutable-vector
                         #:description
                         "This contract is equivalent to the `mutable-vector?` predicate."
